...
class AxPopover extends StatefulWidget {
  const AxPopover({
    super.key,
    required this.child,
  ...
  @override
  State<AxPopover> createState() => _AxPopoverState();
}

class _AxPopoverState extends State<AxPopover> {
  ...
  @override
  void didUpdateWidget(AxPopover oldWidget) {
